		...
		double *pfG,double *pfReal,double *pfImaginary)
{
    ...
    double fCos, fSin;
    void GaborGetIndexForGauss(int j1,int j2,int nDeltaP,int nL,int maxlh,int l1,int l2,int m,int *k,int *n);
    ...
    void GaborGetCExp(int alpha,int beta,int gamma,int N,int n,double *pfCE1,double *pfCE2,double *pfCE3,double *pfCos,double *pfSin);
 ...
 * get the sin
 */
double GaborGetSin(int alpha,int beta,int gamma,int N,int n,double *pfCE1,double *pfCE2,double *pfCE3)
{
    int index1, index2;
    double value;
 ...
 *
 * input:
 *	nL: 2^nL is the size of the gabsignal (int)
 *
 * output:
 ...
 *
 * input:
 *	nL: 2^nL is the gabsignal size (int)
 *
 * output:
